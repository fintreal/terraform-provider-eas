...
func NewProjectVariableDataSource() datasource.DataSource {
    return &projectVariableDataSource{}
}

type projectVariableDataSource struct{
}


type projectVariableDataSourceModel struct{
...
func (d *projectVariableDataSource) Metadata(_ context.Context, req datasource.MetadataRequest, resp *datasource.MetadataResponse) {
    resp.TypeName = req.ProviderTypeName + "_project_variable"
}

func (d *projectVariableDataSource) Schema(_ context.Context, _ datasource.SchemaRequest, resp *datasource.SchemaResponse) {
...
func (d *projectVariableDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
    var current projectVariableDataSourceModel
    ...
    var state projectVariableDataSourceModel;
    ...
    state = projectVariableDataSourceModel{
